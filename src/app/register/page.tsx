        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <form className="mt-8 space-y-4" action="#" method="POST">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className="appearance-none rounded-xl relative block w-full px-3 py-3 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
                    ...
                    {/* University */}
                    <div>
                        <label htmlFor="university" className="sr-only">الجامعة</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            ...
                            <select
                                id="university"
                                name="university"
                                className="appearance-none rounded-xl relative block w-full px-3 py-3 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm bg-white"
                            >
                                <option value="" disabled selected>اختر الجامعة</option>
                                <option value="ksu">جامعة الملك سعود</option>
                                <option value="pnu">جامعة الإمام</option>
                                <option value="kau">جامعة الملك عبدالعزيز</option>
                            </select>
                        </div>
                    </div>
                    ...
                    {/* Confirm Password */}
                    <div>
                        <label htmlFor="password-confirm" className="sr-only">تأكيد كلمة المرور</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <Lock className="h-5 w-5 text-gray-400" />
                            </div>
